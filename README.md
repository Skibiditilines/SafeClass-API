...
| fun_11 | `utils/weather_utils.py`                                                                              | Lógica de recomendación automática de suspensión según condiciones climáticas |   Erick Daniel   | 01/06/2026 |
| fun_12 | `middlewares/rate_limit_middleware.py`                                                                | Middleware de limitación de tasa (rate limiting)                              |  Elias Martinez  | 28/05/2026 |
