...
def test_fun_10_get_all_suspensions(auth_client, mock_db):
    """fun_10: Listar todas las suspensiones del usuario retorna 200 y una lista."""
    mock_cursor = mock_db.cursor.return_value
    mock_cursor.fetchall.return_value = [
        {"id_suspension": 1, "id_academico": 1, "fecha": "2026-05-05"},
        {"id_suspension": 2, "id_academico": 1, "fecha": "2026-05-06"}
    ]
...
def test_fun_10_get_suspension_by_date(auth_client, mock_db):
    """fun_10: Obtener suspensión por fecha específica retorna 200 y el objeto."""
    mock_cursor = mock_db.cursor.return_value
